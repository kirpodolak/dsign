"""
Legacy monolithic SocketService (superseded by `dsign/services/sockets/` package).

Kept for reference only. Previously lived as `sockets.py` next to the `sockets/` directory,
which shadowed the package and broke modular imports — do not restore that layout.
"""
