...
const CATALOG = {
  ru: {
    ...
    service_digital_signage: 'digital-signage',
    service_mpv: 'mpv',
    service_network_assistant: 'network-assistant',
    ...
    network_assistant_boot_mode: 'Wi‑Fi помощник при старте',
    network_assistant_boot_mode_on: 'Всегда',
    network_assistant_boot_mode_auto: 'При офлайне',
    network_assistant_boot_mode_off: 'Выкл',
    value_na: 'н/д',
    value_auto: 'Авто',
  ...
  en: {
    ...
    service_screenshot: 'screenshot',
    os_linux: 'OS Linux',
    network_assistant_boot_mode: 'Wi‑Fi assist at boot',
    network_assistant_boot_mode_on: 'Always',
    network_assistant_boot_mode_auto: 'When offline',
    network_assistant_boot_mode_off: 'Off',
