...
const CATALOG = {
  ru: {
    ...
    network_assistant_boot_tooltip: 'Помощник Wi‑Fi при загрузке: ВЫКЛ — только IP; ОФЛ — nmtui если нет сети; ВКЛ — всегда nmtui; DBG — статус + Wi‑Fi на экране.',
  ...
  en: {
    ...
    network_assist_toggle_debug: 'DBG',
    wifi_on_display_short: 'WiFi',
    wifi_on_display_tooltip: 'Open Wi‑Fi picker on content display (over mpv)',
    wifi_on_display_started: 'Wi‑Fi setup started on player display',
    wifi_on_display_failed: 'Failed to open Wi‑Fi on display',
    wifi_on_display_short: 'WiFi',
    wifi_on_display_tooltip: 'Открыть выбор Wi‑Fi на экране контента (поверх mpv)',
    wifi_on_display_started: 'Выбор Wi‑Fi запущен на экране плеера',
    wifi_on_display_failed: 'Не удалось открыть Wi‑Fi на экране',
    network_assistant_boot_tooltip: 'Wi‑Fi assist at boot: OFF — IP only; OFL — nmtui when offline; ALW — always nmtui; DBG — debug status screen 10s.',
