...
| **H-REF** | Refactor длинных методов (после тестов) | 🟡 | improvement §10 | PR1: `playback_eof.py` |
...
- [ ] **PR2:** network stream helpers (`_wait_mpv_stream_ready`, headers, midstream reload)
...
**Следующий PR по качеству:** **H-REF PR2** (network stream helpers) или **H-COAL**
