...
| **H-REF** | Refactor длинных методов (после тестов) | 🟡 | improvement §10 | PR1–3 ✅; PR4 открыт |
...
*Файлы:* `playback_eof.py`, `playback_network.py`, `playback_slideshow.py`, `test_playback_slideshow_module.py`
...
**Следующий PR по качеству:** **H-REF PR4** (`_play_impl`) или **H-COAL**
...
| Дата | Изменение |
|------|-----------|
| 2026-07-10 | H-REF PR3 ✅ (`playback_slideshow.py`; playlist ~2930 lines) |
